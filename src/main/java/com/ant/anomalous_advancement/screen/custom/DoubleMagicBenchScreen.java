...
public class DoubleMagicBenchScreen extends HandledScreen<DoubleMagicBenchScreenHandler> {
    private static final Identifier GUI_TEXTURE =
            Identifier.of(Anomalous_Advancement.MOD_ID, "textures/gui/double_magic_bench/double_magic_bench_gui.png");

    public DoubleMagicBenchScreen(DoubleMagicBenchScreenHandler handler, PlayerInventory inventory, Text title) {
    ...
    protected void drawForeground(DrawContext context, int mouseX, int mouseY) {
        ...
        DoubleMagicBenchEntity bench = handler.getBlockEntity();
